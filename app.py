...
<div class="card"><b>SETA Learnership - Retail</b><br>Stipend: R2,500/month<br><button class="btn" onclick="window.open('https://www.sayouth.mobi','_blank')">Apply on SA Youth.mobi</button></div>
...
<h2>🎓 NSFAS</h2>
<div class="card"><b>NSFAS Application</b><br>For University & TVET<br><button class="btn" onclick="window.open('https://www.nsfas.org.za','_blank')">Apply on nsfas.org.za</button></div>
</div>
...
document.getElementById('cvout').style.display='block';document.getElementById('cvout').innerText=cv;
...
document.getElementById('aiout').style.display='block';document.getElementById('aiout').innerText=ans;
}
</script>
</body>
</html>
